...
class _CategoriesScreenState extends State<CategoriesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_activeTab == 0) {
      displayedCategories = provider.categories
          .where((c) => c.isExpense && c.id != 'other_expense')
          .toList();
    } else if (_activeTab == 1) {
      displayedCategories = provider.categories
          .where((c) => !c.isExpense && c.id != 'other_income')
          .toList();
    } else {
      // System Tab
      displayedCategories = [
        ...
        const Category(
          id: 'sys_bundled_notes',
          name: 'Catatan Terbundle',
