...
class _AnalyticsScreenState extends State<AnalyticsScreen> {
        ...
        body: SafeArea(
          child: TabBarView(
            children: [
              ...
              _buildYearlyPlaceholder(context, isDarkVal, mainTextColor, subTextColor),
              _buildRangePlaceholder(context, isDarkVal, mainTextColor, subTextColor),
            ],
          ),
        ),
      ),
  ...
  // --- Placeholders for Tahunan & Rentang ---

  Widget _buildYearlyPlaceholder(BuildContext context, bool isDarkVal, Color mainTextColor, Color subTextColor) {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(Icons.calendar_today_rounded, size: 50, color: subTextColor.withValues(alpha: 0.2)),
          const SizedBox(height: 12),
          Text('Segera Hadir', style: TextStyle(color: mainTextColor, fontWeight: FontWeight.bold, fontSize: 15)),
          const SizedBox(height: 4),
          Text('Analisis statistik tahunan sedang disiapkan.', style: TextStyle(color: subTextColor, fontSize: 12)),
        ],
      ),
    );
  }

  Widget _buildRangePlaceholder(BuildContext context, bool isDarkVal, Color mainTextColor, Color subTextColor) {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(Icons.date_range_rounded, size: 50, color: subTextColor.withValues(alpha: 0.2)),
          const SizedBox(height: 12),
          Text('Segera Hadir', style: TextStyle(color: mainTextColor, fontWeight: FontWeight.bold, fontSize: 15)),
          const SizedBox(height: 4),
          Text('Analisis dengan kustom rentang tanggal sedang disiapkan.', style: TextStyle(color: subTextColor, fontSize: 12)),
        ],
      ),
    );
  }
